...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Corner Images with Proper Positioning */
        .corner-image {
            position: absolute;
            width: 120px;
            height: auto;
        ...
        .menu {
            ...
            background: linear-gradient(135deg, var(--primary-color), #6b5c45);
            color: var(--white);
            z-index: 10;
            display: none;
        ...
        @media (max-width: 600px) {
            .page {
                padding: 15px;
                padding-bottom: calc(var(--menu-height) + 3rem);
            }
...
<body>
    <div class="wrapper">
        ...
        <div id="rsvp" class="page">
            ...
            <button class="btn-konfirmasi" onclick="openUcapanModal()" aria-label="Konfirmasi kehadiran dan kirim ucapan">
        ...
        <div id="gifts" class="page">
            ...
            <div id="cashless-container" class="cashless-wrapper" style="display: none;" aria-hidden="true">
                <div class="bank-card">
                    ...
                    <div>
                        <h3>0402982622</h3>
                        <p>BCA : Yogi Prayoga</p>
                        <button class="copy-btn" onclick="copyRekening('0402982622', this)"
                        ...
                        <form id="ucapanForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group">
                                    ...
                                    <div class="radio-item">
                                        <input type="radio" id="tidak_hadir" name="kehadiran" value="tidak_hadir" required>
    ...
    <script>
        ...
        function openInvitation() {
            ...
            setTimeout(() => {
                ...
                const left = document.querySelector('.corner-bottom-left');
                const right = document.querySelector('.corner-bottom-right');
                const inviteText = document.querySelector('.invite-text');
                left.style.bottom = '76px';
                right.style.bottom = '70px';
                inviteText.style.marginBottom = '1.5rem';

                // 🔍 Tambahkan media query di sini
                const isMobile = window.matchMedia("(max-width: 600px)").matches;
                if (isMobile) {
                    const leftCorner = document.querySelector('.corner-bottom-left');
                    const rightCorner = document.querySelector('.corner-bottom-right');

                    if (leftCorner) {
                        leftCorner.style.bottom = '160px';
                        leftCorner.style.left = '0';
                    }

                    if (rightCorner) {
                        rightCorner.style.bottom = '153px';
                        rightCorner.style.right = '10px';
                    }
                }
        ...
        const UcapanModal = {
            ...
            async handleSubmit(e) {
                ...
                try {
                    const response = await fetch('/ucapan', {
                        method: 'POST',
                        body: formData,
                        headers: {
