...
<head>
    ...
    <title>Ferry Adel Wedding | Admin Panel </title>
    <link rel="icon" type="image/x-icon" href="https://designreset.com/cork/html/src/assets/img/favicon.ico" />
    <link href="https://designreset.com/cork/html/layouts/modern-light-menu/css/light/loader.css" rel="stylesheet"
        type="text/css" />
    <link href="https://designreset.com/cork/html/layouts/modern-light-menu/css/dark/loader.css" rel="stylesheet"
        type="text/css" />
    <script src="https://designreset.com/cork/html/layouts/modern-light-menu/loader.js"></script>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="https://designreset.com/cork/html/src/bootstrap/css/bootstrap.min.css" rel="stylesheet"
        type="text/css" />
    <link href="https://designreset.com/cork/html/layouts/modern-light-menu/css/light/plugins.css" rel="stylesheet"
        type="text/css" />
    <link href="https://designreset.com/cork/html/layouts/modern-light-menu/css/dark/plugins.css" rel="stylesheet"
        type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link rel="stylesheet" type="text/css"
        href="https://designreset.com/cork/html/src/assets/css/light/elements/alert.css">
    <link rel="stylesheet" type="text/css"
        href="https://designreset.com/cork/html/src/assets/css/dark/elements/alert.css">
...
<body class="layout-boxed">
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="https://designreset.com/cork/html/src/assets/img/profile-16.jpeg"
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    <img src="https://designreset.com/cork/html/src/assets/img/profile-15.jpeg"
                                        class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="https://designreset.com/cork/html/src/assets/img/profile-21.jpeg"
                                        class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                        ...
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar"
                                    src="https://designreset.com/cork/html/src/assets/img/profile-30.png"
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        <div class="nav-item theme-text">
                            <a href="javascript:void(0);" class="nav-link"> F&A Wedding </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active" id="kehadiranMenu">
                        <a href="javascript:void(0);" aria-expanded="false" class="dropdown-toggle" id="kehadiran"
                            data-url="{{ route('ferry-adel.admin.attendance') }}" data-menu="kehadiran">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class="menu" id="giftsMenu">
                        <a href="javascript:void(0);" aria-expanded="false" class="dropdown-toggle" id="gifts"
                            data-url="{{ route('ferry-adel.admin.gifts') }}" data-menu="gifts">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active page-menu-title" aria-current="page">Kehadiran</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                    ...
                    <!-- CONTENT AREA -->
                    <div class="row layout-top-spacing render-content">
                        {{-- RENDER CONTENT --}}
                    </div>
                    <!-- CONTENT AREA -->
    ...
    <script src="https://designreset.com/cork/html/src/plugins/src/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    ...
    <script>
        function getContent(url) {
            $.get(url, function(data) {
                $('.render-content').html(data.view);
            });
        }

        $(document).ready(function() {
            var url = $('#kehadiran').data('url');
            getContent(url);
            ...
            $('body').on('click', '.dropdown-toggle', function() {
                ...
                $('.page-menu-title').text(menu).css('text-transform', 'capitalize');
            ...
            $('body').on('click', '.btn-remove', function() {
                ...
                if (confirm('Are you sure want to delete this data?')) {
                    $.ajax({
                        url: '{{ route('ferry-adel.admin.delete.comment') }}',
                        type: 'DELETE',
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}'
